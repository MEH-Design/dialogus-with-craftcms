define('HamburgerAnimation', ['TweenLite', 'EasePack', 'CSSPlugin',
  ...
  var showX = function() {
    TweenLite.to(icon, time, {backgroundColor: 'rgba(120,190,32,0)',
      ease:ease});
    TweenLite.to(before, time, {cssRule:{transformOrigin:'left top',
      rotation: 45, marginLeft: '1.5vw', top: '-0.9vw'}, ease:ease});
    TweenLite.to(after, time, {cssRule:{transformOrigin:'left bottom',
      rotation: -45, marginLeft: '1.5vw', top: '0.9vw'}, ease:ease});
  };
